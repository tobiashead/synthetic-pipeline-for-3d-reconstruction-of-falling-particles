...
csv_file_path = Path(ParameterStudy_OutputPath) / csv_file_name
...
for i, com in enumerate(combinations):
    print(f"Start simulation with parameter set {i}/{n_combinations}. Estimated remaining total running time: {total_remaining_running_time/3600:.2f} hours")
...
with open(Path(ParameterStudy_OutputPath) / "OutputPaths.txt", "w") as file:
